...
#vainilla_cnn.save_weights('vainilla_cnn_age_1_trainfold0to3_4.h5')
vainilla_cnn.load_weights('vainilla_cnn_age_1_trainfold0to3_4.h5')
...
np.save("vainilla_cnn_test_res_4", np.array(test_res))
print dir(history)
#np.save("vainilla_cnn_history_4", history)
