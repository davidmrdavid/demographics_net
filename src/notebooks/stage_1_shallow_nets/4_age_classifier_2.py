...
vainilla_cnn.add(Dense(output_dim=300, input_dim=500))
vainilla_cnn.add(BatchNormalization())
vainilla_cnn.add(Activation("relu"))
vainilla_cnn.add(Dense(output_dim=150, input_dim=300))
vainilla_cnn.add(BatchNormalization())
vainilla_cnn.add(Activation("relu"))
...
#vainilla_cnn.save_weights('vainilla_cnn_age_1_trainfold0to3_2.h5')
vainilla_cnn.load_weights('vainilla_cnn_age_1_trainfold0to3_2.h5')
...
#np.save("vainilla_cnn_history_2", history)
#np.save("vainilla_cnn_test_res_2", np.array(test_res))
